...
Haoguang Zhou \quad\textbullet\quad Charles Wang \quad\textbullet\quad Peiyao Shou\par}

\vspace{2cm}

{\small
\begin{tabular}{@{}rl@{}}
\textbf{GitHub} & \url{https://github.com/1355-XCZ/Assignment1_2026} \\[0.25em]
\textbf{Google Drive} & \url{https://drive.google.com/drive/folders/1eOBr8ZURxk3jv8Tn1UxyPXCV26MFCaMY?usp=sharing} \\
\end{tabular}
\par}
...
\textbf{Report structure.}\quad This report comprises two parts. Sections~1--7 document the debugging and repair of a QANet (Yu et al.~\cite{yu2018qanet}) implementation for extractive question answering on a subset of SQuAD~1.1 (Rajpurkar et al.~\cite{rajpurkar2016squad}). Section~8 confirms the repaired model's baseline performance. Sections~9--11 present three hypothesis-driven mechanistic analyses of the repaired model: encoder convolution divergence (H1), CQ Attention directional asymmetry (H2), and Pointer layer wiring necessity (H3). Two appendices provide hyperparameter details (A) and a bug-ID cross-reference index (B).
